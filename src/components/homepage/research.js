    ...
    return (
        <Space direction="vertical" size={20}>
            ...
            <FadeInDiv direction="left">
                ...
                <div>With social interactions moving to the digital realm, the availability of data provides an opportunity to study society and human behavior through digital data. I’m interested in utilizing these online data, especially in social media, to analyze and understand complex online social phenomena. Even in Thailand, many social movements were originated from the online realm.</div>
            </FadeInDiv>
